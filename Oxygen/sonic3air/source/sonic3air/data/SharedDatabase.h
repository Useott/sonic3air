...
public:
	...
	struct Setting
	{
		enum Type		// Hold in sync with script (except for the INVALID entry)
		{
			...
			SETTING_SCREEN_SIZE					= 0x00003402,
			SETTING_CLASSIC_SHIELD_SPRITE		= 0x80003501,
			SETTING_CLASSIC_TRANSPARENCY		= 0x80003600,
			SETTING_WATERFALL_SFX				= 0x80003701,
			SETTING_ACT_SELECT_BIG_RINGS		= 0x00003801,
			SETTING_LANGUAGE					= 0x80003900,
			SETTING_DROWNING_MUSIC				= 0x80003a01,
			SETTING_LIGHTS_OUT_AUDIO			= 0x80003b01,
			SETTING_WINTER_AUDIO				= 0x80003c00,
			SETTING_RANDOM_MONITOR_TYPE			= 0x80003d00,
			SETTING_MHZ_INTRO_AUDIO				= 0x80003e00,
			SETTING_EXTRA_LIFE_SOUND_MODE		= 0x80003f00,
			SETTING_AIZ1_FIRE_AUDIO				= 0x80004001,
		};
