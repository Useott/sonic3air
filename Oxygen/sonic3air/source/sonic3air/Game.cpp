...
void Game::registerScriptBindings(lemon::Module& module)
{
	...
	// Game
	{
		...
		builder.addNativeFunction("Game.openOptionsMenuFromAITMenu", lemon::wrap(*this, &Game::openOptionsMenuFromAITMenu), defaultFlags);
		builder.addNativeFunction("Game.openModsMenu", lemon::wrap(*this, &Game::openModsMenu), defaultFlags);
		builder.addNativeFunction("Game.openTimeAttackMenu", lemon::wrap(*this, &Game::openTimeAttackMenu), defaultFlags);
		...
		builder.addNativeFunction("Game.getBuildNumber", lemon::wrap(*this, &Game::getBuildNumber), defaultFlags);

		builder.addNativeFunction("Game.exit", lemon::wrap(*this, &Game::exit), defaultFlags);
	}
