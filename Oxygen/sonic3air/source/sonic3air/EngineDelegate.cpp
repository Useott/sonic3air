...
const EngineDelegateInterface::AppMetaData& EngineDelegate::getAppMetaData()
{
	...
	{
		mAppMetaData.mTitle = "Angel Island Tour";
...
{
	CrashHandler::setApplicationInfo(std::string("Angel Island Tour v") + BUILD_STRING);
	oxygen::Logging::setAssertBreakCaption(std::string("Angel Island Tour - v") + BUILD_STRING);
